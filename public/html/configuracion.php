    ...
    <div class="w3-bar w3-red w3-card w3-left-align w3-large">
      ...
      <div class="w3-display-right">
        <div class="w3-xxlarge w3-cell">
          <a href="configuracion.php"><i class="material-icons w3-xxlarge w3-white">person</i></a>
        </div>
        <div class="w3-cell">
          <a href="../../index.php" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white w3-cell">Cerrar Sesión</a>
        </div>
      </div>
    </div>
